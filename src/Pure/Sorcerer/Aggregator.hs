module Pure.Sorcerer.Aggregator 
  ( Aggregator(..)
  , toAggregator
  , persist
  , integrate
...
import Pure.Sorcerer.Aggregable as Aggregable
import Pure.Sorcerer.Aggregate as Aggregate
import Pure.Sorcerer.JSON
import Pure.Sorcerer.Streamable as Streamable
